...
<html>
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <ul class="breadcrumb" itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">					
                                ...
                                <li><strong itemprop="title">${sessionScope.orgn}</strong></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <section class="products-view products-view-grid">
            <div class="row">
                <c:forEach var="pr" items="${sessionScope.proclist}" begin="${first}" end="${last}">
            ...
            <div class="paginate-pages aligns-item-center" style="margin-right: 50%;">
                <nav class="clearfix">
                    <ul class="pagination clearfix">
                        ...
                        <c:if test="${page > 1}">
                            <li class="page-item"><a class="page-link" href="allservlet?org=${param.org}&page=${page - 1}">&laquo;</a></li>
                            </c:if>
                        <li class="active page-item"><a class="page-link" href="allservlet?org=${param.org}&page=${page}">${page}</a></li>

                        <c:if test="${page == num}">
                            <li class="page-item disabled"><a class="page-link" href="#"  tabindex="-1">&raquo;</a></li>
                            </c:if>
                            <c:if test="${page < num}">
                            <li class="page-item"><a class="page-link" href="allservlet?org=${param.org}&page=${page + 1}">&raquo;</a></li>
                            </c:if>
